...
public class MainActivity extends AppCompatActivity {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!message.isEmpty()) {
                    ...
                    try {
                        jsonObject.put("message", message); // Fixed key: "message"
    ...
    private void instantiateWebSocket() {
        ...
        Request request = new Request.Builder().url("ws://146.141.21.78:8080").build();
        ...
        public void onMessage(@NonNull WebSocket webSocket, @NonNull String text) {
            ...
            activity.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    JSONObject jsonObject = new JSONObject();
                    try {
                        jsonObject.put("message", text); // Fixed key: "message"
    ...
    public class MessageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            try {
                if (item.has("byServer") && item.getBoolean("byServer")) {
